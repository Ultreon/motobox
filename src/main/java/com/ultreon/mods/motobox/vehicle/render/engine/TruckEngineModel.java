...
public class TruckEngineModel extends EntityModel<VehicleEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final EntityModelLayer MODEL_LAYER = new EntityModelLayer(Motobox.id("truck_engine"), "main");
	private final ModelPart bb_main;

	public TruckEngineModel(EntityRendererFactory.Context ctx) {
