package com.ultreon.mods.motobox.vehicle.render.frame;// Made with Blockbench 4.5.2
...
public class RustyCarFrameModel extends EntityModel<VehicleEntity> {
	...
	public static TexturedModelData createBodyLayer() {
		...
		ModelPartData group = modelPartData.addChild("group", ModelPartBuilder.create().uv(93, 100).cuboid(-12.5F, -2.5F, -46.5F, 33.0F, 2.0F, 9.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(77, 116).cuboid(-2.0F, -2.5F, -47.5F, 12.0F, 2.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(95, 65).cuboid(14.5F, -10.5F, -19.0F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(95, 65).cuboid(9.5F, -10.5F, -19.0F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(95, 65).cuboid(10.5F, -9.5F, -19.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(95, 65).cuboid(10.5F, -6.5F, -19.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(95, 65).cuboid(10.5F, -11.5F, -19.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(0, 0).cuboid(-12.5F, -1.5F, -24.5F, 33.0F, 2.0F, 40.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(0, 100).cuboid(-13.0F, -3.0F, 28.0F, 34.0F, 2.0F, 12.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(97, 72).cuboid(-12.5F, -2.5F, 28.5F, 33.0F, 2.0F, 12.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(174, 120).cuboid(-13.0F, -10.0F, 39.0F, 34.0F, 1.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(121, 61).cuboid(-13.0F, -5.0F, 11.0F, 34.0F, 4.0F, 5.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(31, 178).cuboid(11.5F, -9.5F, -20.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(31, 178).cuboid(14.5F, -4.5F, -22.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(31, 178).cuboid(11.5F, -4.5F, -22.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(31, 178).cuboid(8.5F, -4.5F, -22.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(170, 179).cuboid(19.0F, -11.0F, -23.0F, 3.0F, 6.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(137, 187).cuboid(19.0F, -5.0F, -23.0F, 2.0F, 4.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(170, 179).cuboid(19.0F, -11.0F, -6.0F, 3.0F, 6.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(137, 187).cuboid(19.0F, -5.0F, -6.0F, 2.0F, 4.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(68, 201).cuboid(19.75F, -19.5F, -5.0F, 1.0F, 9.0F, 11.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(0, 72).cuboid(19.75F, -19.5F, -15.0F, 1.0F, 9.0F, 9.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(139, 163).cuboid(-13.0F, -5.0F, -25.0F, 34.0F, 4.0F, 2.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(197, 190).cuboid(-12.75F, -19.5F, -5.0F, 1.0F, 9.0F, 11.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(0, 43).cuboid(-12.75F, -19.5F, -15.0F, 1.0F, 9.0F, 9.0F, new Dilation(0.0F, 0.0F, 0.0F))
				...
				.uv(100, 185).cuboid(-13.0F, -5.0F, -23.0F, 2.0F, 4.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(0, 0).cuboid(-14.0F, -11.0F, -23.0F, 3.0F, 6.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(0, 0).cuboid(-14.0F, -11.0F, -6.0F, 3.0F, 6.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F))
				.uv(100, 185).cuboid(-13.0F, -5.0F, -6.0F, 2.0F, 4.0F, 17.0F, new Dilation(0.0F, 0.0F, 0.0F)), ModelTransform.pivot(-12.0F, 21.0F, 12.0F));
